      ...
      <main>
        <section id="keyer-section">
          <div
            ...
            tabindex="0"
            role="button"
            aria-label="CW Clicker - click to send Morse code"
          >
...
if (!settingsButton.parentElement) {
  ...
  settingsButton.style.cssText =
    'position: absolute; top: 20px; right: 20px; font-size: 1.5rem; background: none; border: none; cursor: pointer;'
